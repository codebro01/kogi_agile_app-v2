    ...
    <>
      ...
      userPermissions.includes('handle_payments') ? (
        <Container maxWidth="lg" sx={{ marginTop: 4, marginBottom: '50px' }}>
          ...
          <Box>
            <Button onClick={mergeStudentsDataIntoPayments}>
          ...
          >
            ...
            <Grid container spacing={2} alignItems="center">
              ...
              <Grid item xs={12} sm={6} md={4}>
                ...
                <Select
                  ...
                  labelId="year-label"
                >
                  <MenuItem value={currentYear}>{getCurrentYear()}</MenuItem>
                </Select>
              </Grid>

              <Grid item xs={12} sm={6} md={4}>
                <InputLabel id="paymentStatus-label" sx={{ marginBottom: 1 }}>
                  All Banks
                </InputLabel>
                <Select
                  name="bankName"
            ...
            <Box display="flex" justifyContent="space-between" gap={2} mt={2}>
              ...
              {paymentsData.length > 0 && (
                <Button
                  onClick={() =>
                    exportToCSV(paymentsData, 'Students Payment Record')
                  }
                  variant="contained"
                  size="large"
                  sx={{
          ...
          {isModalOpen && (
            ...
            >
              ...
              >
                ...
                <p>
                  <strong>Student ID:</strong> {selectedItem.studentRandomId}
                </p>
                <p>
                  <strong>Name:</strong>{' '}
