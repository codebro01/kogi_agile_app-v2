...
export const AttendanceTakerSignInForm = () => {
    const theme = useTheme();
    const colors = tokens(theme.palette.mode)
    const { login, userPermissions } = useAuth(); // Access login function from context
    const [isLoading, setIsLoading] = useState(false)
    ...
    const handleSubmit = (event) => {
        ...
        (async () => {
            try {
                setIsLoading(true)
                const response = await axios.post(`${API_URL}/attendance-takers/login`, { email, password }, { withCredentials: true });
                ...
                // Attendance Taker dashboard navigate
                navigate('/attendance-taker-dashboard');
                ...
                >
                    ...
                    <Divider
                        sx={{
                            marginY: 2,
                            "&::before, &::after": {
                                borderColor: colors.main["darkGreen"],
                            },
                            fontSize: "1.2rem",
                            color: colors.main["darkGreen"],
                            fontWeight: "bold",
                    ...
                    >
                        ...
                        <Button
                            ...
                            sx={{
                                ...
                                mb: 2,
                                fontSize: "1.2rem",
                                background: validationError ? "red" : isLoading ? "white" : colors.main["darkGreen"],
                                color: validationError ? "white" : "inherit",
                                "&:hover": {
                                    background: validationError ? "darkred" : colors.main["lightGreen"],
                                    opacity: 0.9,
                                },
                            }}
                        ...
                        <Box textAlign="center" sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                            ...
                            <Typography fontWeight="600" sx={{ color: colors.main["darkGreen"] }}>KOGI STATE MINISTRY OF EDUCATION</Typography>
                        </Box>
                    </Box>
                </Paper>
            </Container>
