...
export const UpdateParentRelationship = () => {
  ...
  const handleBankAccountDetailsUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.patch(
        `${API_URL}/student/update/student-parent-relationship`,
        formData,
        {
          headers: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Upload an excel file here to update student parent relationship
        </Typography>
