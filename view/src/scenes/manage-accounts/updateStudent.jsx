...
export const UpdateStudent = () => {
  ...
  if (fetchSchoolError) {
    return (
      ...
      >
        <Typography>
          An Error occurred fetching schools, please reload the page!!!
        </Typography>
      </Box>
    );
  }
  ...
  const allWards = lgasAndWards
    .flatMap((ward) => ward.wards)
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
                  ...
                  <Autocomplete
                    ...
                    onChange={(event, newValue) => {
                      if (newValue) {
                        ...
                        setFormData({
                          ...formData,
                          ["schoolId"]: newValue._id,
                        }); // Set schoolId in formData
                      }
                    }}
                ...
                >
                  {allWards.map((ward, index) => (
                    <MenuItem key={index} value={ward}>
                      {" "}
                      {/* Assuming `ward` is an object with `id` */}
              ...
              <Grid item xs={12}>
                {" "}
                {/* Adjusts the grid item size based on screen size */}
                {/* <Autocomplete
                  value={wardValue}
                  onChange={(event, newValue) => {
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    helperText={
                      errors["Year of Enrollment"] &&
                      `${"Year of enrollment of"} is required`
                    }
                  >
